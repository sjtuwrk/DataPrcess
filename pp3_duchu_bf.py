...
#    print("text59 is %s:" + text59)
    c = nltk.word_tokenize(text59)
    #print(c)
    strArr = ["LIMITED", "LIMITED.", "GROUP", ",LTD", "UNIT", "LTD", "CO.LTD.", "CO.,LTD", "CO.,", "MILL C O,." "LTD  CO.", "LTD", "MILL",
              "CO LTD", "CO.,LIMITED", "CO LTD", "COMPANY", "MANUFACTURING", "LLC", "CO,. LTD", ",LTD.", ",LTD", "CORP", "CORP.", "KG", ",LTD",
